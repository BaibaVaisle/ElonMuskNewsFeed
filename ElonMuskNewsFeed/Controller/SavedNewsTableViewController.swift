...
class SavedNewsTableViewController: UITableViewController {
    ...
    func saveData(){
            do{
                try context?.save()
                basicAlert(title: "Deleted!", message: "You have erased from CoreData your article.")
            }catch{
    ...
    @IBAction func infoButtonTapped(_ sender: Any) {
        basicAlert(title: "Saved News Info!", message: "In this section you will find your saved articles. \nIf you decide to delete some articles, you can do it by using \"Edit\" button and click on delete symbol, or alternative way is to pointer on related article and swipe from right side the left, then press \"delete\"! \nIf you want to reorganize your saved news - hold on the right side and drag the article to the necessary place after you have pressed \"Edit\".")
            }
